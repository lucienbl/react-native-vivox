...
/**
 * Type of SDK used path
 */
typedef enum {
    /**
     * Path to folder where internal SDK data are stored.
     * Ends with platform specific separator.
     */
    path_cache_folder = 0
} vx_path_id;

/**
 * Get specific path of various files and folders used by SDK.
 *
 * @param path id.
